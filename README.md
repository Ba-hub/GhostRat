...
```
$ python3 server.py generate --address 134.276.92.1 --port 2999 --output payload.py --source
```
...
```
$ python3 server.py generate --address 134.276.92.1 --port 2999 --output /tmp/filer.py
```
